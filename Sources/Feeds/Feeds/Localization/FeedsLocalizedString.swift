//
//  FeedsLocalizedString.swift
//  Feeds
//
//  Created by Coruț Fabrizio on 10.09.2021.
//  Copyright © 2021 Coop. All rights reserved.
//
...
public func FeedsLocalizedString(_ key: String, comment: String = "", _ args: CVarArg...) -> String {
	ModuleLocalizedString(key, comment: comment, args, tableName: "Feeds", module: .module)
}
