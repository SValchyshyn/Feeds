//
//  CustomerFeedbackLocalizedString.swift
//  CustomerFeedback
//
//  Created by Coruț Fabrizio on 03.09.2021.
...
public func CustomerFeedbackLocalizedString(_ key: String, comment: String = "", _ args: CVarArg...) -> String {
	ModuleLocalizedString(key, comment: comment, args, tableName: "CustomerFeedback", module: .module)
}
